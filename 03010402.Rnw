...
# Generic discrete random variable, affine combinations of discrete random variables, standard deviation
...
(b = sample(c(-1,1), 1) * sample(2:20, 1))
...
if(language=='en'){
  question=paste0(
    ...
    probString,
    ".\\end{center} Find the {\\bf standard deviation of the random variable} \\[Y=",a,"\\cdot X",qString01,".\\] Use  ",
  ...
  question=paste0(
    ...
    probString,
    ".\\end{center} Calcula la {\\bf desviaci\\'on t\\'{\\i}pica de la variable aleatoria discreta definida mediante} \\[Y=",a,"\\cdot X",qString01,".\\] Usa  ",
