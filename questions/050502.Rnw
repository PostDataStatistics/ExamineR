...
if(language=='en'){
  question=paste0("$X$ is a normal ramdom variable.  
                    Given a random sample of length $", n,"$ with 
                  sample standar deviation $s=",s,"$  calculate the {\\bf top} $b$  of the confidence interval $(a,b)$ for the {\\bf standard deviation} $\\sigma_X$, with a confidence level $",100*cl,"$\\%.\\
Use ", signifDig, "  significant digits in your answer.")
  ...
  answer=paste0("The answer is ", sol)
    ...
    question=paste0(" La variable aleatoria $X$ es normal. Se ha obtenido una muestra de tama\\~no
                    $",n,"$ y cuasidesviaci\\'on t\\'ipica muestral $s=",s,"$. Calcula el {\\bf extremo superior} $b$ de un intervalo de confianza $(a,b)$ para la 
