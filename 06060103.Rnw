...
Utiliza 4 cifras significativas en tu respuesta."
  ...
  answer=paste0(" The value of the test-statistics is $\\frac{\bar X_1-\bar X_2}{\\sqrt{\frac{\\hat{s}_1^2}{n_1}+\frac{\\hat{s}_1^2}{n_1}}}=",signif( statistic,digits=4),"$. The solution is $s =", sol,"$.")
...
Utiliza 4 cifras significativas en tu respuesta."
  ...
  answer=paste0(" El estad\\'istico es $\\frac{\bar X_1-\bar X_2}{\\sqrt{\frac{\\hat{s}_1^2}{n_1}+\frac{\\hat{s}_1^2}{n_1}}}=",signif( statistic,digits=4),"$.  La soluci\\'on  es  $s =", sol,"$.")
