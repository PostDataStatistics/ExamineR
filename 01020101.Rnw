...
sol <- signif((n-1) * var(data) / n, digits = signifDig)
...
if(language=='en'){
  question=paste0(
"Find the \\textbf{(population) variance} of this set of numbers:\\begin{center}",
    dataString,
  ...
  question=paste0(
    "Calcula la \\textbf{varianza (poblacional)} de este conjunto de n\\'umeros:\\begin{center}",
    dataString,
