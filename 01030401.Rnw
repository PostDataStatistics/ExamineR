...
## Given a boxplot, identify the corresponding histogram
...
if(language=='en'){
  question=paste0("Which of the following histograms corresponds to the boxplot? ")
  
}else if(language=='es'){
  question=paste0("El diagrama de caja y bigotes se corresponde con uno de los histogramas, 
...
par(mfrow=c(2,2))
boxplot(unlist(lista[sol]), main="Boxplot", horizontal = TRUE)   
hist(sample1, main="Muestra 1") 
hist(sample2, main="Muestra 2")
hist(sample3, main="Muestra 3")
@
\end{center}
\end{figure}
