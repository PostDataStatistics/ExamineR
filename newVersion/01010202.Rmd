...
question=paste0("Find the **median** of the set of numbers in the attached file.")
...
question = paste0(
"Calcula la **mediana** del conjunto de números del fichero adjunto.")
