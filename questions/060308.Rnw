...
Se repite un experimento de tipo Bernoull\\'i $n=", n,"$ veces  
 la proporci\\'on muestral de  \\'exitos es $\\hat{p}=\\frac{", nhat, "}{", n, "}$. 
              ...
              $$H_0:\\,p  ", symbol, " p_0$$
donde $p_0=", p0,"$. Determina el menor n\\'umero de \\'exitos que se debe observar para rechazar $H_0$. 
"
 )
...
p_* = {\\tt qnorm(",alpha,", mean = ", p0,", sd = \\sqrt{\\frac{(",nhat,"/",n,") (",n-nhat,"/",n,") }{",n,"}}), lower.tail = FALSE)}
\\end{equation}
