...
# Generic discrete random variable. Variance from the mass function table
...
if(language=='en'){
  question=paste0(
    ...
    probString,
    ".\\end{center} Find the \\{\\bf variance\\} of $X$. Use  ",
  ...
  question=paste0(
    ...
    probString,
    ".\\end{center} Calcula la {\\bf varianza}  de $X$. Redondea el resultado con ",
