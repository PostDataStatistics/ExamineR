...
## 01010002 Absolute frequencies from csv file.
```
...
question=paste0("Find the **arithmetic mean** of the set of numbers in the attached file.")
...
question = paste0(
"Calcula la **media aritmética** del conjunto de números del fichero adjunto.")
