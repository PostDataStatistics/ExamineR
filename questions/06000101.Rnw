...
if(language=='en'){
  ...
  answer=paste0("To be traslated.")
     ...
     if(language=='es'){
  question=paste0("Se quiere comprobar si la media en cierta poblaci\\'on ", type,"  ", mu0 ,". Se toma una muestra y se calcula su media, que vale ",barX,". \\textquestiondown Cu\\'al es la hip\\'otesis ", hypothesis ,"?")
