...
Se repite un experimento de tipo Bernoull\\'i $n=", n,"$ veces y  
 la proporci\\'on muestral de  \\'exitos es $\\hat{p}=\\frac{", nhat, "}{", n, "}$. 
              ...
              $$H_0:\\,p  ", symbol, " p_0$$
donde $p_0=", p0,"$. Si se observan menos de ",n0," \\'exitos, 
determina el mayor n\\'umero de \\'exitos que se debe observar para rechazar $H_0$. 
"
 )
...
p_* = {\\tt qnorm(",alpha/2,", mean = ", p0,", sd = \\sqrt{\\frac{(",nhat,"/",n,") (",n-nhat,"/",n,") }{",n,"}}), lower.tail = TRUE)}
\\end{equation}
