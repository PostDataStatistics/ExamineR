...
if(language=='en'){
  question=paste0(
    ...
    probString,
    ".\\] Find the mean of {\\bf the random variable defined by} \\[Y=",a,"\\cdot X",qString01,".\\] Use  ",
  ...
  question=paste0(
    ...
    probString,
    ".\\] Calcula la media de {\\bf la variable aleatoria discreta definida mediante} \\[Y=",a,"\\cdot X",qString01,".\\] Usa  ",
