...
while((abs(sol)<0.0001)|(abs(sol)>999)){
    ...
    TestType=3 # 1 to test H1: sigma > sigma0, 2 to test H1: sigma < sigma0, 3 to test H1: sigma = sigma0
...
question=paste0("$X$ is a normal random variable. 
                ...
                $s^2=", signif(s^2, digits = sDigits), "$. 
              Test the null hypothesis:
             $$H_0:\\sigma_X^2 ", symbol, " \\sigma_0^2$$
...
Use 4 significant digits."
  ...
  question=paste0("La variable aleatoria $X$ es normal. 
                ...
                con varianza muestral $s^2=", signif(s^2, digits = sDigits), "$. 
