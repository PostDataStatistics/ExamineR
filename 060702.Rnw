...
while((abs(sol)<0.00001)|(abs(sol)>999)){
    ...
    TestType=2 # Ha: 1 to test p1 > p2, 2 to test p1 < p2, 3 to test p1 = p2
...
if(language=='en'){
  question=paste0("Given the random variables $X_1$ and $X_2$, the interest is on the proportion of individuals of each population displaying  a given property. Therefore, we get two random samples of sizes $n_1=", n1,"$ and $n_2=", n2,"$ that produce, respectively, 
