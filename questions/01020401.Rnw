...
(sol <- signif(sd(data), digits = signifDig))
...
if(language=='en'){
  question=paste0(
"Find the \\textbf{(sample) standard deviation} of this set of numbers:\\begin{center}",
    dataString,
  ...
  question=paste0(
    "Calcula la \\textbf{desviaci\\'on t\\'ipica (muestral)} de este conjunto de n\\'umeros:\\begin{center}",
    dataString,
