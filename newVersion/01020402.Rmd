...
## 01020402 ->- Sample standard deviation  from csv file.
```
...
question=paste0("Find the **sample standard deviation** of the set of numbers in the attached file.")
...
question = paste0(
"Calcula la **(cuasi)desviación típica muestral** del conjunto de números del fichero adjunto.")
