...
if(language=='en'){
  ...
  answer=paste0("To be traslated.")
     ...
     if(language=='es'){
  question=paste0("Se quiere comprobar si las medias $",means[1],"$ y $",means[2],"$ de dos poblaciones ", type,"  entre s\\'i. Se toman sendas muestras y obtienen las medias muestrales ",barX[1]," y ",barX[2],". \\textquestiondown Cu\\'al es la hip\\'otesis ", hypothesis ,"?")
