...
if(language=='en'){
  ...
  answer=paste0("The answer is ", sol)
    ...
    question=paste0("$T$ es una variable aleatoria que sigue una distribuci\\'on t de Student con ", n," gradosde libertad. Calcula la probabilidad $$P(", a," <  T < ", b," ).$$  Escribe tu respuesta con ", signifDig, " cifras significativas." )
